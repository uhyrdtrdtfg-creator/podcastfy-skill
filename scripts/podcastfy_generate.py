...
- Runs `python -m podcastfy.client`.
...
def ensure_deps() -> None:
    ...
    # Podcastfy's website extractor uses Playwright. Ensure a browser is installed.
    # (Chromium is enough for most pages.)
    try:
...
def main(argv: list[str]) -> int:
    ...
    llm_model = os.getenv("PODCASTFY_LLM_MODEL", "gemini-1.5-flash")
...
llm_model = os.environ.get("PODCASTFY_LLM_MODEL", "gemini-2.0-flash")
